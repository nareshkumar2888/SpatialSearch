      ...
      <div id="content_inner">
        <div id="sidebar">
          ...
          <div class="sidebar_box">
            <h2></h2>
           <img src="images/book.jpeg"  height="200" alt="" />
            <p></p>
            <p></p>
...
<table align="center" bgcolor="#333300" height="200" width="400">
<tr>
...
while (rs.next())
{
sid=rs.getString("rno");
a=rs.getString("bookname");
b=rs.getString("isbn");
c=rs.getString("author");
d=rs.getString("publisher");
e=rs.getString("amount");
...
{
%>
<td><a href="update1.jsp?<%=sid%>"><font color="#FF0000"><%=g%></font></a></td>
</tr>
<%
