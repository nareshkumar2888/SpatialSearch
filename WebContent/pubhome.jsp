  ...
  <div id="main_wrapper">
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/spatia.png" alt="" />
      ...
      <div class="header_right">
        ...
        <div id="menu">
          <ul>
            <li><a href="pubhome.jsp"  class="current">Publisher</a></li>
      ...
      <div id="content_inner">
        <div id="sidebar">
          ...
          <div class="sidebar_box">
            <h2></h2>
            <img src="images/publlish.jpeg" height="350" width="280" alt="" />
			<p></p>
			<p></p>
          </div>
        </div>
        <div id="content">
          ...
          <h2></h2>
		    ...
		    <img src="images/publisher.jpeg" height="350" width="550" alt="" />
